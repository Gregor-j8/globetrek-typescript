        ...
        <div className="w-full h-screen flex items-center justify-center ">
            <div className="flex w-2/5 flex-col bg-main-card p-8">
                <section className=" flex justify-around">
                    <Link href={`/profile/${PostDetail?.user?.id}`}>
                    ...
                    {currentUser.id !== PostDetail.user?.id
                        ? <footer className="flex justify-around">
                            <p className="text-color-primary">{PostDetail.date}</p>
                                <button className="button-primary rounded-lg p-2" onClick={() => {router.push("/posts")}}>Return</button>
                            </footer>
                        : <footer className="flex  flex-col text-l p-2">
                            ...
                            <div className="flex items-center justify-around pt-8 font-bold">
                                <button className="cursor-pointer rounded-lg text-color-primary p-2 button-primary" onClick={() => {router.push("edit")}}>Edit</button> 
                                <button className="button-primary rounded-lg p-2" onClick={() => {router.push("/posts")}}>Return</button>
