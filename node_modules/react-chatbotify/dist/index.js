import "./style.css";
import { jsxs as z, jsx as l, Fragment as tA } from "react/jsx-runtime";
import * as X from "react";
import { forwardRef as cA, createContext as DA, useContext as EA, Fragment as YA, useRef as $, useState as I, useCallback as T, useEffect as W, isValidElement as ue, createElement as ne, useMemo as gA } from "react";
import Ne from "react-dom/server";
const q = {
  ...
  header: {
    ...
    showAvatar: !0,
    avatar: se,
    buttons: [q.NOTIFICATION_BUTTON, q.AUDIO_BUTTON, q.CLOSE_CHAT_BUTTON],
    closeChatIcon: Ke
  },
  notification: {
    disabled: !1,
  ...
  chatInput: {
    ...
    buttons: [q.VOICE_MESSAGE_BUTTON, q.SEND_MESSAGE_BUTTON]
  },
  chatWindow: {
    showScrollbar: !1,
  ...
  footer: {
        ...
        children: [
          ...
          /* @__PURE__ */ l(
            "div",
            {
              ...
              children: /* @__PURE__ */ l(re, { style: { width: "80%", height: "80%", fill: "#fff" } })
            },
            1
          ),
    ...
    buttons: [q.FILE_ATTACHMENT_BUTTON, q.EMOJI_PICKER_BUTTON]
  },
  fileAttachment: {
    disabled: !1,
    multiple: !0,
...
}, de = DA({ settings: {}, setSettings: () => null }), M = () => EA(de), rt = ({
  children: A,
  settings: e = fe,
  setSettings: t
}) => /* @__PURE__ */ l(de.Provider, { value: { settings: e, setSettings: t }, children: A }), we = {
  tooltipStyle: {},
...
}, ge = DA({ styles: {}, setStyles: () => null }), R = () => EA(ge), at = ({
  children: A,
  styles: e = we,
  setStyles: t
}) => /* @__PURE__ */ l(ge.Provider, { value: { styles: e, setStyles: t }, children: A }), ct = ({ buttons: A }) => {
  var n, s, a, r, c;
  const { settings: e } = M(), { styles: t } = R(), o = {
    backgroundImage: `linear-gradient(to right, ${(n = e.general) == null ? void 0 : n.secondaryColor},
			${(s = e.general) == null ? void 0 : s.primaryColor})`,
    ...t.headerStyle
  };
  return /* @__PURE__ */ z("div", { style: o, className: "rcb-chat-header-container", children: [
    /* @__PURE__ */ z("div", { className: "rcb-chat-header", children: [
    ...
    /* @__PURE__ */ l("div", { className: "rcb-chat-header", children: A == null ? void 0 : A.map(
      (i, u) => /* @__PURE__ */ l(YA, { children: i }, u)
    ) })
  ] });
}, Be = DA({}), AA = () => EA(Be), it = ({
  children: A,
  ...
  const o = $(null), n = $(""), s = $(/* @__PURE__ */ new Map()), a = $(null), r = $(""), c = $(!1), i = $(null), u = $(null), f = $(null);
  return /* @__PURE__ */ l(Be.Provider, { value: {
    botIdRef: e,
    flowRef: t,
    inputRef: o,
    streamMessageMap: s,
  ...
  var N, J, K, V, vA, iA;
  const [t, o] = I(!1), [n, s] = I(((N = e == null ? void 0 : e.chatWindow) == null ? void 0 : N.defaultOpen) ?? !1), [a, r] = I(((J = e == null ? void 0 : e.audio) == null ? void 0 : J.defaultToggledOn) ?? !1), [c, i] = I(((K = e == null ? void 0 : e.voice) == null ? void 0 : K.defaultToggledOn) ?? !1), [u, f] = I(
    ((V = e == null ? void 0 : e.notification) == null ? void 0 : V.defaultToggledOn) ?? !0
  ), [h, d] = I(!1), [w, D] = I(!1), [v, P] = I(!1), [g, C] = I(!0), [Q, B] = I(!1), [E, b] = I(!1), [k, y] = I(!1), [S, m] = I(0), [p, x] = I(0), [O, L] = I(!1), [F, _] = I(null), [G, j] = I(((vA = window.visualViewport) == null ? void 0 : vA.height) ?? window.innerHeight), [U, Y] = I(((iA = window.visualViewport) == null ? void 0 : iA.width) ?? window.innerWidth);
  return /* @__PURE__ */ l(ve.Provider, { value: {
    isBotTyping: t,
    setIsBotTyping: o,
    isChatWindowOpen: n,
    ...
    setNotificationsToggledOn: f,
    isLoadingChatHistory: h,
    setIsLoadingChatHistory: d,
    hasChatHistoryLoaded: w,
    setHasChatHistoryLoaded: D,
    isScrolling: v,
    setIsScrolling: P,
    textAreaDisabled: g,
    setTextAreaDisabled: C,
    textAreaSensitiveMode: Q,
    setTextAreaSensitiveMode: B,
    hasInteractedPage: E,
    setHasInteractedPage: b,
    hasFlowStarted: k,
    setHasFlowStarted: y,
    unreadCount: S,
    setUnreadCount: m,
    inputLength: p,
    setInputLength: x,
    blockAllowsAttachment: O,
    setBlockAllowsAttachment: L,
    timeoutId: F,
    setTimeoutId: _,
    viewportHeight: G,
    setViewportHeight: j,
  ...
  var w, D, v;
  const { settings: A } = M(), { styles: e } = R(), { unreadCount: t, isScrolling: o, setIsScrolling: n } = eA(), { chatBodyRef: s } = AA(), [a, r] = I(!1), c = {
  ...
  function f(P) {
    if (!s.current)
      return;
    const g = s.current.scrollTop, Q = s.current.scrollHeight - s.current.clientHeight - g, B = 20;
    let E = 0;
    function b() {
      if (!s.current)
        return;
      E += B;
      const k = h(E, g, Q, P);
      s.current.scrollTop = k, E < P ? requestAnimationFrame(b) : n(!1);
    }
    b();
  }
  const h = (P, g, C, Q) => (P /= Q / 2, P < 1 ? C / 2 * P * P + g : (P--, -C / 2 * (P * (P - 2) - 1) + g));
  return /* @__PURE__ */ l("div", { className: `rcb-message-prompt-container ${(() => {
    var g;
    return s.current && ((g = A.chatWindow) == null ? void 0 : g.showMessagePrompt) && o && t > 0 ? "visible" : "hidden";
  })()}`, children: /* @__PURE__ */ l(
    "div",
    {
      onMouseEnter: i,
      ...
      onMouseDown: (P) => {
        P.preventDefault(), f(600);
      },
      className: "rcb-message-prompt-text",
      children: (v = A.chatWindow) == null ? void 0 : v.messagePromptText
    }
  ) });
}, H = {
  // audio
...
}, Pe = DA({ paths: [], setPaths: () => null }), XA = () => EA(Pe), dt = ({ children: A }) => {
  const [e, t] = I([]);
  return /* @__PURE__ */ l(Pe.Provider, { value: { paths: e, setPaths: t }, children: A });
}, TA = () => {
  const { settings: A } = M(), { paths: e, setPaths: t } = XA(), {
    setIsBotTyping: o,
    setTextAreaDisabled: n,
    setTextAreaSensitiveMode: s,
    blockAllowsAttachment: a,
    setBlockAllowsAttachment: r
  } = eA(), { botIdRef: c } = AA(), i = T(() => e.length > 0 ? e[e.length - 1] : null, [e]), u = T(() => e.length > 1 ? e[e.length - 2] : null, [e]), f = T(async (d) => {
    var w, D;
    if ((w = A.event) != null && w.rcbChangePath) {
      const v = i(), P = u(), g = { botId: c.current, currPath: v, prevPath: P };
      if (event = await HA(H.CHANGE_PATH, g, { currPath: v, prevPath: P, nextPath: d }), event.defaultPrevented)
        return !1;
    }
    return o(!0), (D = A.chatInput) != null && D.blockSpam && n(!0), s(!1), t((v) => [...v, d]), !0;
  }, [e, t, A]), h = T((d) => {
    t(d);
  }, []);
  return {
  ...
  const { getCurrPath: A, getPrevPath: e, paths: t } = wt(), { botIdRef: o } = AA();
  return { callRcbEvent: T(async (s, a) => {
  ...
  const { settings: A } = M(), {
    isChatWindowOpen: e,
    setIsChatWindowOpen: t,
    viewportHeight: o,
    setViewportHeight: n,
    viewportWidth: s,
    setViewportWidth: a,
    setUnreadCount: r
  } = eA(), { callRcbEvent: c } = dA(), [i, u] = I(0), f = T(async () => {
    var d;
    (d = A.event) != null && d.rcbToggleChatWindow && (await c(
      H.TOGGLE_CHAT_WINDOW,
      { currState: e, newState: !e }
    )).defaultPrevented || t((w) => (w || r(0), !w));
  }, [e]), h = T(async (d) => {
    e !== d && await f();
  }, [e]);
  return {
...
}, he = DA({ messages: [], setMessages: () => null }), WA = () => EA(he), gt = ({ children: A }) => {
  const [e, t] = I([]);
  return /* @__PURE__ */ l(he.Provider, { value: { messages: e, setMessages: t }, children: A });
}, Bt = ({
  message: A,
  isNewSender: e
}) => {
  var f, h, d, w, D, v;
  const { settings: t } = M(), { styles: o } = R(), n = typeof A.content == "string", s = A.content, a = A.contentWrapper ? /* @__PURE__ */ l(A.contentWrapper, { children: s }) : s, r = {
    backgroundColor: (f = t.general) == null ? void 0 : f.primaryColor,
    color: "#fff",
    maxWidth: (h = t.userBubble) != null && h.showAvatar ? "65%" : "70%",
    ...o.userBubbleStyle
  }, c = (d = t.userBubble) != null && d.animate ? "rcb-user-message-entry" : "", i = ((w = t.userBubble) == null ? void 0 : w.showAvatar) && e, u = `rcb-user-message${!e && ((D = t.userBubble) != null && D.showAvatar) ? " rcb-user-message-offset" : ""}`;
  return /* @__PURE__ */ z("div", { className: "rcb-user-message-container", children: [
    n ? /* @__PURE__ */ l("div", { style: r, className: `${u} ${c}`, children: a }) : /* @__PURE__ */ l(tA, { children: a }),
    i && /* @__PURE__ */ l(
      "div",
      {
        style: { backgroundImage: `url("${(v = t.userBubble) == null ? void 0 : v.avatar}")` },
  ...
  var f, h, d, w, D, v;
  const { settings: t } = M(), { styles: o } = R(), n = typeof A.content == "string", s = A.content, a = A.contentWrapper ? /* @__PURE__ */ l(A.contentWrapper, { children: s }) : s, r = {
    backgroundColor: (f = t.general) == null ? void 0 : f.secondaryColor,
    color: "#fff",
    maxWidth: (h = t.botBubble) != null && h.showAvatar ? "65%" : "70%",
    ...o.botBubbleStyle
  }, c = (d = t.botBubble) != null && d.animate ? "rcb-bot-message-entry" : "", i = ((w = t.botBubble) == null ? void 0 : w.showAvatar) && e, u = `rcb-bot-message${!e && ((D = t.botBubble) != null && D.showAvatar) ? " rcb-bot-message-offset" : ""}`;
  return /* @__PURE__ */ z("div", { className: "rcb-bot-message-container", children: [
    i && /* @__PURE__ */ l(
      "div",
      {
        style: { backgroundImage: `url("${(v = t.botBubble) == null ? void 0 : v.avatar}")` },
  ...
  var o, n, s;
  const { settings: A } = M(), { styles: e } = R(), t = (o = A.botBubble) != null && o.animate ? "rcb-bot-message-entry" : "";
  return /* @__PURE__ */ z("div", { className: "rcb-bot-message-container", children: [
    ...
    /* @__PURE__ */ l(
      "div",
      {
        ...
        className: `rcb-bot-message ${t}`,
        children: /* @__PURE__ */ z("div", { className: "rcb-typing-indicator", style: { ...e == null ? void 0 : e.rcbTypingIndicatorContainerStyle }, children: [
  ...
  var d, w, D;
  const { settings: e } = M(), { styles: t } = R(), { messages: o } = WA(), { isChatWindowOpen: n } = wA(), {
    isBotTyping: s,
    isScrolling: a,
    setIsScrolling: r,
    setUnreadCount: c
  } = eA(), { chatBodyRef: i } = AA(), u = {
    ...t == null ? void 0 : t.bodyStyle,
    scrollbarWidth: (d = e.chatWindow) != null && d.showScrollbar ? "auto" : "none"
  };
  W(() => {
    i.current && (A(i.current.scrollHeight), a || (i.current.scrollTop = i.current.scrollHeight));
  }, [(w = i.current) == null ? void 0 : w.scrollHeight]);
  const f = () => {
    var Q, B;
    if (!i.current)
      return;
    A(i.current.scrollHeight);
    const { scrollTop: v, clientHeight: P, scrollHeight: g } = i.current, C = v + P < g - (((Q = e.chatWindow) == null ? void 0 : Q.messagePromptOffset) ?? 30);
    r(C), C || (v + P >= g - 1 && (i.current.scrollTop = g - P - 1), (n || (B = e.general) != null && B.embedded) && c(0));
  }, h = (v) => v === 0 ? !0 : o[v].sender !== o[v - 1].sender;
  return /* @__PURE__ */ z(
    "div",
    {
      style: u,
      ...
      children: [
        o.map((v, P) => {
          const g = h(P);
          return v.sender.toUpperCase() === "USER" ? /* @__PURE__ */ l(Bt, { message: v, isNewSender: g }, P) : v.sender.toUpperCase() === "BOT" ? /* @__PURE__ */ l(vt, { message: v, isNewSender: g }, P) : /* @__PURE__ */ l("div", { children: v.content }, P);
        }),
        s && ((D = e.chatWindow) == null ? void 0 : D.showTypingIndicator) && /* @__PURE__ */ l(Pt, {}),
        /* @__PURE__ */ l(ut, {})
      ]
    }
  );
  ...
  var v, P, g, C, Q, B, E, b, k, y, S;
  const { settings: o } = M(), { styles: n } = R(), { paths: s } = XA(), { handleSubmitText: a } = pA(), [r, c] = I(/* @__PURE__ */ new Set()), [i, u] = I(!1), f = {
    cursor: i ? `url("${(v = o.general) == null ? void 0 : v.actionDisabledIcon}"), auto` : "pointer",
    color: (P = o.general) == null ? void 0 : P.primaryColor,
    borderColor: (g = o.general) == null ? void 0 : g.primaryColor,
    ...n.botCheckboxRowStyle
  }, h = {
    cursor: i || r.size < A.min ? `url("${(C = o.general) == null ? void 0 : C.actionDisabledIcon}"), auto` : "pointer",
    color: (Q = o.general) == null ? void 0 : Q.primaryColor,
    borderColor: (B = o.general) == null ? void 0 : B.primaryColor,
    ...n.botCheckboxNextStyle
  }, d = {
    cursor: i ? `url("${(E = o.general) == null ? void 0 : E.actionDisabledIcon}"), auto` : "pointer",
    color: "transparent",
    ...n.botCheckMarkStyle
  }, w = {
    cursor: i ? `url("${(b = o.general) == null ? void 0 : b.actionDisabledIcon}"), auto` : "pointer",
    color: "#fff",
    borderColor: (k = o.general) == null ? void 0 : k.primaryColor,
    backgroundColor: (y = o.general) == null ? void 0 : y.primaryColor,
    ...n.botCheckMarkSelectedStyle
  };
  W(() => {
    s.length > 0 && s[s.length - 1] !== t && u(!A.reusable);
  }, [s]);
  const D = (m) => {
    i || c((p) => {
      const x = new Set(p);
      if (x.has(m))
        e.delete(m), x.delete(m);
      else {
        if (r.size == A.max)
          return p;
        e.add(m), x.add(m);
  ...
  return /* @__PURE__ */ z("div", { className: `rcb-checkbox-container ${(S = o.botBubble) != null && S.showAvatar ? "rcb-checkbox-offset" : ""}`, children: [
    A.items.map((m) => /* @__PURE__ */ l(
      "div",
      {
        onMouseDown: (p) => {
          p.preventDefault(), D(m);
        },
        style: f,
        className: "rcb-checkbox-row-container",
        children: /* @__PURE__ */ z("div", { className: "rcb-checkbox-row", children: [
          /* @__PURE__ */ l(
            "div",
            {
              style: r.has(m) ? w : d,
          ...
          /* @__PURE__ */ l("div", { className: "rcb-checkbox-label", children: m })
        ] })
      },
      m
    )),
    /* @__PURE__ */ l(
      "div",
      {
        ...
        onMouseDown: (m) => {
          var O;
          if (m.preventDefault(), i || r.size < A.min)
            return;
          const p = Array.from(e).join(", ");
          u(!A.reusable);
          let x;
          A.sendOutput != null ? x = A.sendOutput : x = ((O = o.chatInput) == null ? void 0 : O.sendCheckboxOutput) ?? !0, a(p, x);
        }
      }
    )
  ] });
  ...
  const r = /* @__PURE__ */ l(Dt, { checkboxes: s, checkedItems: /* @__PURE__ */ new Set(), path: t });
  ...
  if (!t)
    return;
  if (typeof t == "string") {
    t.trim() !== "" && await e.injectMessage(t);
    return;
  }
  let o = t(e);
  o instanceof Promise && (o = await o), o && o.trim() !== "" && await e.injectMessage(o);
}, bt = ({
  options: A,
  path: e
}) => {
  var w, D, v, P, g, C;
  const { settings: t } = M(), { styles: o } = R(), { paths: n } = XA(), { handleSubmitText: s } = pA(), [a, r] = I([]), [c, i] = I(!1), u = {
    cursor: c ? `url("${(w = t.general) == null ? void 0 : w.actionDisabledIcon}"), auto` : "pointer",
    ...
    backgroundColor: (g = t.general) == null ? void 0 : g.primaryColor,
  ...
  return /* @__PURE__ */ l("div", { className: `rcb-options-container ${(C = t.botBubble) != null && C.showAvatar ? "rcb-options-offset" : ""}`, children: A.items.map((Q, B) => {
    const E = a[B] && !c;
    return /* @__PURE__ */ l(
      "div",
      {
        ...
        onMouseDown: (b) => {
          ...
          i(!A.reusable);
          let k;
          A.sendOutput != null ? k = A.sendOutput : k = ((y = t.chatInput) == null ? void 0 : y.sendOptionOutput) ?? !0, s(Q, k);
        },
        children: Q
      },
      Q
  ...
  const a = /* @__PURE__ */ l(bt, { options: s, path: t });
  ...
  if (typeof o == "string")
    return t(o);
  let n = o(e);
  return n instanceof Promise && (n = await n), n ? t(n) : !1;
}, pt = async (A, e) => {
  const t = A.component;
  if (t) {
  ...
  let r;
  if (typeof a == "function" ? (r = a(t), r instanceof Promise && (r = await r)) : r = a, typeof r == "number" && (r = { duration: r }), !r || r instanceof Promise || r.duration == null || typeof r.duration != "number")
    return;
  ...
  if (o == null)
    return;
  let n;
  typeof o == "function" ? (n = o(t), n instanceof Promise && (n = await n)) : n = o, e(n);
}, De = async (A, e, t) => {
  ...
  for (const a of s)
    a === "function" && await Ct(n, t);
  return s.includes("path") ? await mt(n, t, o) : !1;
}, Mt = () => {
  var t;
  const { settings: A } = M(), { styles: e } = R();
  return /* @__PURE__ */ l("div", { className: "rcb-line-break-container", children: /* @__PURE__ */ l(
    "div",
    {
      ...
      children: (t = A.chatHistory) == null ? void 0 : t.chatHistoryLineBreakText
    }
  ) });
}, kt = () => {
  var o;
  const { settings: A } = M(), { styles: e } = R(), t = {
    borderTop: `4px solid ${(o = A.general) == null ? void 0 : o.primaryColor}`,
    ...e.loadingSpinnerStyle
  };
  return /* @__PURE__ */ l("div", { className: "rcb-spinner-container", children: /* @__PURE__ */ l("div", { style: t, className: "rcb-spinner" }) });
}, xA = () => {
  try {
...
let BA, Ce = !1, OA = "rcb-history", MA = 30, Qe = !1, SA = [];
const UA = async (A) => {
  if (Qe || !BA)
    return;
  const e = [], t = Ce ? SA.length : 0;
  ...
  BA && BA.setItem(OA, JSON.stringify(A));
}, Ot = () => {
  BA && BA.removeItem(OA);
}, GA = (A) => {
  var e, t, o, n, s;
  ((t = (e = A.chatHistory) == null ? void 0 : e.storageType) == null ? void 0 : t.toUpperCase()) === "SESSION_STORAGE" ? BA = sessionStorage : BA = localStorage, OA = (o = A.chatHistory) == null ? void 0 : o.storageKey, MA = (n = A.chatHistory) == null ? void 0 : n.maxEntries, Qe = (s = A.chatHistory) == null ? void 0 : s.disabled, SA = Ht(BA.getItem(OA));
}, Lt = (A) => ue(A.content) ? structuredClone({
  id: A.id,
  content: Ne.renderToString(A.content),
  type: A.type,
  sender: A.sender.toUpperCase(),
  timestamp: A.timestamp,
  tags: A.tags
}) : A, Nt = (A, e, t, o, n, s, a, r) => {
  var c;
  if (Ce = !0, t != null)
    try {
      o((u) => {
        const f = QA(/* @__PURE__ */ l(kt, {}), "SYSTEM");
        return u.shift(), [f, ...u];
      });
      const i = t.map((u) => {
        if (u.type === "object") {
          const f = ye(u.content, A, e);
          return { ...u, content: f };
        }
        return u;
      });
      setTimeout(() => {
        o((u) => {
          ...
          u.shift();
          let f;
          return (h = A.chatHistory) != null && h.autoLoad ? f = QA(/* @__PURE__ */ l(tA, {}), "SYSTEM") : f = QA(/* @__PURE__ */ l(Mt, {}), "SYSTEM"), [...i, f, ...u];
        }), r(!0);
      }, 500), setTimeout(() => {
        if (!n.current)
          return;
        const { scrollHeight: u } = n.current, f = u - s;
        n.current.scrollTop = n.current.scrollTop + f, a(!1);
      }, 510);
    } catch {
      BA.removeItem((c = A.chatHistory) == null ? void 0 : c.storageKey);
    }
}, ye = (A, e, t) => {
  ...
  return Array.from(n.body.childNodes).map((r, c) => {
      ...
      return r.textContent;
    {
      ...
      let f = Array.from(r.attributes).reduce((d, w) => {
        const D = w.name.toLowerCase();
        if (D === "style") {
          const v = w.value.split(";").filter((g) => g.trim() !== ""), P = {};
          v.forEach((g) => {
            const [C, Q] = g.split(":").map((E) => E.trim()), B = C.replace(/-([a-z])/g, (E, b) => b.toUpperCase());
            P[B] = Q;
          }), d[D] = P;
        } else (u === "audio" || u === "video") && D === "controls" && w.value === "" ? d[D] = "true" : d[D] = w.value;
        return d;
      }, {});
      if (Object.prototype.hasOwnProperty.call(f, "class")) {
        const d = r.classList;
        f.className = d.toString(), delete f.class, (i = e.botBubble) != null && i.showAvatar && (f = Ft(d, f)), f = Ut(d, f, e, t), f = Rt(d, f, e, t), f = jt(d, f, e, t), f = zt(d, f, e, t);
      }
      if ([
        "area",
        "base",
        ...
        return ne(u, { key: c, ...f });
      {
        const d = ye(r.innerHTML, e, t);
        return ne(u, { key: c, ...f }, ...d);
      }
    }
  });
}, Ft = (A, e) => ((A.contains("rcb-options-container") || A.contains("rcb-checkbox-container")) && (e.className = `${A.toString()} rcb-options-offset`), e), Ut = (A, e, t, o) => {
  var n, s, a, r, c;
  return A.contains("rcb-options") && (e.style = {
    ...e.style,
    color: ((n = o.botOptionStyle) == null ? void 0 : n.color) ?? ((s = t.general) == null ? void 0 : s.primaryColor),
    borderColor: ((a = o.botOptionStyle) == null ? void 0 : a.color) ?? ((r = t.general) == null ? void 0 : r.primaryColor),
    cursor: `url("${(c = t.general) == null ? void 0 : c.actionDisabledIcon}"), auto`,
    ...o.botOptionStyle
  }), e;
}, Rt = (A, e, t, o) => {
  var n, s, a, r, c;
  return A.contains("rcb-checkbox-row-container") && (e.style = {
    ...e.style,
    color: ((n = o.botCheckboxRowStyle) == null ? void 0 : n.color) ?? ((s = t.general) == null ? void 0 : s.primaryColor),
    borderColor: ((a = o.botCheckboxRowStyle) == null ? void 0 : a.color) ?? ((r = t.general) == null ? void 0 : r.primaryColor),
    cursor: `url("${(c = t.general) == null ? void 0 : c.actionDisabledIcon}"), auto`,
  ...
  return A.contains("rcb-checkbox-next-button") && (e.style = {
    ...e.style,
    color: ((n = o.botCheckboxNextStyle) == null ? void 0 : n.color) ?? ((s = t.general) == null ? void 0 : s.primaryColor),
    borderColor: ((a = o.botCheckboxNextStyle) == null ? void 0 : a.color) ?? ((r = t.general) == null ? void 0 : r.primaryColor),
    cursor: `url("${(c = t.general) == null ? void 0 : c.actionDisabledIcon}"), auto`,
  ...
  return (A.contains("rcb-media-display-image-container") || A.contains("rcb-media-display-video-container")) && (e.style = {
    ...e.style,
    backgroundColor: (n = t.general) == null ? void 0 : n.primaryColor,
  ...
  const { settings: A } = M(), {
    ...
    unreadCount: n,
    setUnreadCount: s
  } = eA(), { audioBufferRef: a, audioContextRef: r, gainNodeRef: c } = AA(), { callRcbEvent: i } = dA(), u = T(async () => {
    var v, P;
    const d = (v = A.notification) == null ? void 0 : v.sound;
    r.current = new AudioContext();
    const w = r.current.createGain();
    w.gain.value = ((P = A.notification) == null ? void 0 : P.volume) ?? 0.2, c.current = w;
    let D;
    if (d != null && d.startsWith("data:audio")) {
      const g = atob(d.split(",")[1]), C = new ArrayBuffer(g.length), Q = new Uint8Array(C);
      for (let B = 0; B < g.length; B++)
        Q[B] = g.charCodeAt(B);
      D = C;
    } else
      D = await (await fetch(d)).arrayBuffer();
    a.current = await r.current.decodeAudioData(D);
  }, [A.notification]), f = T(() => {
    var w;
    if ((w = A.notification) != null && w.disabled || !e || !o || !r.current || !a.current)
      return;
    const d = r.current.createBufferSource();
    d.buffer = a.current, d.connect(c.current).connect(r.current.destination), d.start();
  }, [
    A.notification,
    e,
    o,
    ...
    var d;
    (d = A.event) != null && d.rcbToggleNotifications && (await i(
      H.TOGGLE_NOTIFICATIONS,
      { currState: e, newState: !e }
    )).defaultPrevented || t((w) => !w);
  }, [e]);
  return {
    unreadCount: n,
    setUnreadCount: s,
  ...
  s.text = A, s.lang = e, s.rate = o, s.volume = n;
  let a = !1;
  for (const r of t)
  ...
  Gt(
    ...
    (o = A.audio) == null ? void 0 : o.voiceNames,
    (n = A.audio) == null ? void 0 : n.rate,
    (s = A.audio) == null ? void 0 : s.volume
  );
}, JA = () => {
  const { settings: A } = M(), { audioToggledOn: e, setAudioToggledOn: t } = eA(), { callRcbEvent: o } = dA(), n = T(async () => {
    var a;
    (a = A.event) != null && a.rcbToggleAudio && (await o(
      H.TOGGLE_AUDIO,
      { currState: e, newState: !e }
    )).defaultPrevented || t((r) => !r);
  }, [e]), s = T(async (a) => {
    var c, i;
    if ((c = A.audio) != null && c.disabled || !e || typeof a.content != "string" || a.content.trim() === "")
      return;
    let r = a.content;
    if ((i = A.event) != null && i.rcbStartSpeakAudio) {
      const u = await o(H.START_SPEAK_AUDIO, { textToRead: r });
  ...
  var B, E, b, k;
  const { settings: A } = M(), { messages: e, setMessages: t } = WA(), o = $(e);
  W(() => {
    o.current = e;
  }, [e]);
  const {
    ...
    setIsBotTyping: r,
    setUnreadCount: c
  } = eA(), { streamMessageMap: i, chatBodyRef: u } = AA(), { callRcbEvent: f } = dA(), { speakAudio: h } = JA(), { playNotificationSound: d } = qA(), w = T(async (y, S, m = null) => {
    y.sender = y.sender.toUpperCase(), r(!1);
    const p = { ...y, content: "" };
    t((_) => {
      const G = [..._, p];
      return C(G), G;
    ...
    S = S.toUpperCase();
    let m = QA(y, S), p = null;
    if ((L = A.event) != null && L.rcbPreInjectMessage) {
      const N = await f(H.PRE_INJECT_MESSAGE, { message: m });
      if (N.defaultPrevented)
        return null;
      p = N.data.simStreamChunker ? N.data.simStreamChunker : p, m = N.data.message;
    }
    m.sender.toUpperCase() === "BOT" && (s || (F = A.general) != null && F.embedded) && h(m);
    const x = typeof m.content == "string" && m.sender === "BOT" && ((_ = A == null ? void 0 : A.botBubble) == null ? void 0 : _.simStream), O = typeof m.content == "string" && m.sender === "USER" && ((G = A == null ? void 0 : A.userBubble) == null ? void 0 : G.simStream);
    if (c((N) => N + 1), (j = A.event) != null && j.rcbPostInjectMessage && await f(H.POST_INJECT_MESSAGE, { message: m }), x) {
      const N = (U = A.botBubble) == null ? void 0 : U.streamSpeed;
      await w(m, N, p);
    } else if (O) {
      const N = (Y = A.userBubble) == null ? void 0 : Y.streamSpeed;
      await w(m, N, p);
    } else
      t((N) => {
        const J = [...N, m];
    ...
    return m.id;
  }, [A, n, s, f, w]), v = T(async (y) => {
    var m;
    const S = o.current.find((p) => p.id === y);
    return !S || (m = A.event) != null && m.rcbRemoveMessage && (await f(H.REMOVE_MESSAGE, { message: S })).defaultPrevented ? null : (t((p) => {
      const x = p.filter((O) => O.id !== y);
      return C(x), x;
    }), c((p) => Math.max(p - 1, 0)), y);
  }, [f, (B = A.event) == null ? void 0 : B.rcbRemoveMessage]), P = T(async (y, S = "BOT") => {
    var p, x;
    if (S = S.toUpperCase(), !i.current.has(S)) {
      const O = QA(y, S);
      return (p = A.event) != null && p.rcbStartStreamMessage && (await f(H.START_STREAM_MESSAGE, { message: O })).defaultPrevented ? null : (r(!1), t((L) => {
        const F = [...L, O];
        return C(F), [...L, O];
      }), i.current.set(S, O.id), c((L) => L + 1), O.id);
    }
    const m = { ...QA(y, S), id: i.current.get(S) };
    return (x = A.event) != null && x.rcbChunkStreamMessage && (await f(H.CHUNK_STREAM_MESSAGE, { message: m })).defaultPrevented ? null : (t((O) => {
      const L = [...O];
      ...
      return C(L), L;
    }), i.current.get(S) ?? null);
  }, [f, (E = A.event) == null ? void 0 : E.rcbChunkStreamMessage, (b = A.event) == null ? void 0 : b.rcbStartStreamMessage, i]), g = T(async (y = "BOT") => {
    var p;
    if (y = y.toUpperCase(), !i.current.has(y))
      return !0;
    const S = i.current.get(y), m = o.current.find((x) => x.id === S);
    return (p = A.event) != null && p.rcbStopStreamMessage && (await f(H.STOP_STREAM_MESSAGE, { messageToEndStreamFor: m })).defaultPrevented ? !1 : (i.current.delete(y), UA(o.current), !0);
  }, [f, (k = A.event) == null ? void 0 : k.rcbStopStreamMessage, i]), C = (y) => {
    var p, x;
    UA(y);
    let S = !0;
    (y.length === 0 || s && !a) && (S = !1), (p = A.general) != null && p.embedded && me(u.current) && (S = !1);
    const m = y[y.length - 1];
    (!m || m.sender.toUpperCase() === "USER") && (S = !1), S && d(), ((x = A.chatWindow) != null && x.autoJumpToBottom || !a) && setTimeout(() => {
...
let RA, uA, kA, hA = !1, aA = null;
const VA = () => {
  if (!RA) {
    const A = window.SpeechRecognition || window.webkitSpeechRecognition;
    RA = A != null ? new A() : null;
  }
  return RA;
}, Xt = (A, e, t, o, n, s, a) => {
  var r;
  (r = A.voice) != null && r.sendAsAudio ? Kt(t, s) : Wt(
    A,
    e,
    t,
    o,
  ...
  if (!hA)
    try {
      hA = !0, a.lang = (i = A.voice) == null ? void 0 : i.language, a.start();
    } catch {
    }
  const r = (u = A.voice) == null ? void 0 : u.timeoutPeriod, c = (f = A.voice) == null ? void 0 : f.autoSendPeriod;
  a.onresult = (h) => {
    var w, D;
    clearTimeout(uA), uA = null, clearTimeout(kA);
    const d = h.results[h.results.length - 1][0].transcript;
    if (s.current) {
      const v = (w = A.chatInput) == null ? void 0 : w.characterLimit, P = s.current.value + d;
      v != null && v >= 0 && P.length > v ? o(P.slice(0, v)) : o(P), n(s.current.value.length);
    }
    r && (uA = setTimeout(async () => await jA(e, s), r)), (D = A.voice) != null && D.autoSendDisabled || (kA = setTimeout(t, c));
  }, a.onend = () => {
    hA ? (a.start(), !uA && r && (uA = setTimeout(async () => await jA(e, s), r))) : (clearTimeout(uA), uA = null, clearTimeout(kA));
  }, r && (uA = setTimeout(async () => await jA(e, s), r));
}, Kt = (A, e) => {
  navigator.mediaDevices.getUserMedia({ audio: !0 }).then((t) => {
    if (aA = new MediaRecorder(t), !hA)
      try {
        hA = !0, aA.start();
      } catch {
      }
    aA.ondataavailable = (o) => {
  ...
  const A = VA();
  A && (hA = !1, A && A.stop(), aA && aA.state !== "inactive" && (aA.stop(), aA = null), clearTimeout(uA), uA = null, clearTimeout(kA));
}, qt = (A, e) => {
  var o, n, s;
  const t = VA();
  (o = e.voice) != null && o.disabled || !((n = e.chatInput) != null && n.blockSpam) || !t || (A && !hA ? (hA = !0, (s = e.voice) != null && s.sendAsAudio ? aA == null || aA.start() : t.start()) : A || ZA());
}, jA = async (A, e) => {
  var t;
  (t = e.current) != null && t.disabled || await A(), ZA();
}, LA = () => {
  const { settings: A } = M(), { voiceToggledOn: e, setVoiceToggledOn: t } = eA(), { callRcbEvent: o } = dA(), n = T(async () => {
    var a;
  ...
  const { settings: A } = M(), {
  ...
  } = eA(), { inputRef: r, chatBodyRef: c, prevInputRef: i } = AA(), { callRcbEvent: u } = dA(), f = T(async (g) => {
    var C, Q, B;
    if (o && r.current) {
      r.current.value = "";
      return;
    ...
    if (r.current && i.current !== null) {
      const E = (C = A.chatInput) == null ? void 0 : C.characterLimit, k = ((Q = A.chatInput) == null ? void 0 : Q.allowNewline) ? g : g.replace(/\n/g, " ");
      if (E != null && E >= 0 && k.length > E ? r.current.value = k.slice(0, E) : r.current.value = k, (B = A.event) != null && B.rcbTextAreaChangeValue && (await u(
    ...
    var C;
    (C = r.current) != null && C.disabled || setTimeout(() => {
      var Q, B, E;
      (Q = A.general) != null && Q.embedded ? me(c == null ? void 0 : c.current) && ((B = r.current) == null || B.focus()) : g !== "start" && ((E = r.current) == null || E.focus());
    }, 100);
  }, []), d = T(() => {
    !o && r.current && r.current.focus();
  }, [o]), w = T(() => {
    r.current && r.current.blur();
  }, []), D = T(() => r && r.current ? r.current.value : "", []), v = T(() => {
    n((g) => !g);
  }, []), P = T(() => {
    a((g) => !g);
  }, []);
...
}, pe = DA({ toasts: [], setToasts: () => null }), Ie = () => EA(pe), Jt = ({ children: A }) => {
  const [e, t] = I([]);
  return /* @__PURE__ */ l(pe.Provider, { value: { toasts: e, setToasts: t }, children: A });
}, mA = () => {
  const { settings: A } = M(), { toasts: e, setToasts: t } = Ie(), { callRcbEvent: o } = dA(), n = $(e);
  W(() => {
    n.current = e;
  }, [e]);
  const s = T(async (c, i) => {
    var w, D, v, P;
    let u = null;
    if (n.current.length >= (((w = A.toast) == null ? void 0 : w.maxCount) ?? 3)) {
      if ((D = A.toast) != null && D.forbidOnMax)
        return null;
      u = xA();
      let g = { id: u, content: c, timeout: i };
      if ((v = A.event) != null && v.rcbShowToast) {
        const C = await o(H.SHOW_TOAST, { toast: g });
        if (C.defaultPrevented)
          return null;
        g = C.data.toast;
      }
      return t((C) => [...C.slice(1), g]), u;
    }
    u = xA();
    let d = { id: u, content: c, timeout: i };
    if ((P = A.event) != null && P.rcbShowToast) {
      const g = await o(H.SHOW_TOAST, { toast: d });
    ...
    var u;
    const i = e.find((f) => f.id === c);
    return !i || (u = A.event) != null && u.rcbDismissToast && (await o(H.DISMISS_TOAST, { toast: i })).defaultPrevented ? null : (t((f) => f.filter((h) => h.id !== c)), c);
  }, [o, t]), r = T((c) => {
    t(c);
  }, []);
  return {
  ...
  var O, L, F, _;
  const { settings: A } = M(), { endStreamMessage: e, injectMessage: t, removeMessage: o, streamMessage: n } = yA(), { getCurrPath: s, getPrevPath: a, goToPath: r } = TA(), {
    timeoutId: c,
    voiceToggledOn: i,
    ...
    setIsBotTyping: d,
    setBlockAllowsAttachment: w,
    setInputLength: D
  } = eA(), { flowRef: v, chatBodyRef: P, inputRef: g, keepVoiceOnRef: C, paramsInputRef: Q } = AA(), { showToast: B, dismissToast: E } = mA(), { callRcbEvent: b } = dA(), { syncVoice: k } = LA(), { setTextAreaValue: y } = bA(), { openChat: S } = wA(), m = T(async (G) => {
    var Y, N, J;
    const j = s();
    if (!(!j || !v.current[j])) {
      if (f) {
        if ((Y = A == null ? void 0 : A.sensitiveInput) != null && Y.hideInUserBubble)
          return;
        if ((N = A == null ? void 0 : A.sensitiveInput) != null && N.maskInUserBubble) {
          await t("*".repeat(((J = A.sensitiveInput) == null ? void 0 : J.asterisksCount) ?? 10), "USER");
          return;
        }
      }
      await t(G, "USER");
    }
  }, [v, s, A, t, f]), p = T(async (G, j, U = !0) => {
    var Y, N;
    j = j.trim(), j !== "" && (U && await m(j), c && clearTimeout(c), Q.current = j, P.current && (P.current.scrollTop = P.current.scrollHeight), g.current && (y(""), D(0)), (Y = A.chatInput) != null && Y.blockSpam && h(!0), C.current = i, k(!1), setTimeout(() => {
      d(!0);
      ...
      if (!await Ee(v.current, G, J, r)) {
        const vA = s();
        if (!vA)
          return;
        const iA = v.current[vA];
        if (!iA)
          return;
        iA.chatDisabled || h((V = A.chatInput) == null ? void 0 : V.disabled), De(iA, u, J), w(typeof iA.file == "function"), k(C.current), d(!1);
      }
    ...
    (F = A.chatInput) == null ? void 0 : F.disabled,
    C,
    i,
    k,
    m,
  ...
  return { handleSubmitText: T(async (G, j = !0) => {
    var Y, N;
    if (G = G ?? ((Y = g.current) == null ? void 0 : Y.value), (N = A.event) != null && N.rcbUserSubmitText && (await b(H.USER_SUBMIT_TEXT, { inputText: G, sendInChat: j })).defaultPrevented)
      return;
    const U = s();
    U && p(U, G, j);
  }, [b, s, p, g, (_ = A.event) == null ? void 0 : _.rcbUserSubmitText]) };
}, NA = () => {
  var t;
  const { settings: A } = M();
  return gA(() => {
    ...
    return n && s;
  }, [(t = A.device) == null ? void 0 : t.applyMobileOptimizations]);
}, Vt = ({ buttons: A }) => {
  var x, O, L, F, _, G, j, U, Y, N, J;
  const e = NA(), { settings: t } = M(), { styles: o } = R(), {
    textAreaDisabled: n,
    textAreaSensitiveMode: s,
    inputLength: a,
    hasFlowStarted: r,
    setHasFlowStarted: c,
    setInputLength: i
  } = eA(), { inputRef: u } = AA(), [f, h] = I(!1), [d, w] = I(!1), { handleSubmitText: D } = pA(), { setTextAreaValue: v } = bA(), P = {
    boxSizing: e ? "content-box" : "border-box",
    ...o.chatInputAreaStyle
  }, g = {
    outline: n ? "" : "none",
    boxShadow: n ? "" : `0 0 5px ${(x = t.general) == null ? void 0 : x.primaryColor}`,
    boxSizing: e ? "content-box" : "border-box",
    ...o.chatInputAreaStyle,
    // by default inherit the base style for input area
    ...o.chatInputAreaFocusedStyle
  }, C = {
    cursor: `url("${(O = t.general) == null ? void 0 : O.actionDisabledIcon}"), auto`,
  ...
  }, E = n ? (L = t.chatInput) == null ? void 0 : L.disabledPlaceholderText : (F = t.chatInput) == null ? void 0 : F.enabledPlaceholderText, b = () => {
    n || h(!0);
  }, k = () => {
    h(!1);
  }, y = () => {
    ...
    if (!d && K.key === "Enter") {
      if (K.shiftKey) {
        (V = t.chatInput) != null && V.allowNewline || K.preventDefault();
        return;
      }
      K.preventDefault(), await D();
    }
  }, p = (K) => {
    u.current && (v(K.target.value), i(u.current.value.length));
  };
  return /* @__PURE__ */ z(
    "div",
    {
      "aria-label": ((_ = t.ariaLabel) == null ? void 0 : _.inputTextArea) ?? "input text area",
      role: "textbox",
      onMouseDown: (K) => {
        var V;
        K.stopPropagation(), !r && ((V = t.general) == null ? void 0 : V.flowStartTrigger) === "ON_CHATBOT_INTERACT" && c(!0);
      },
      style: { ...o.chatInputContainerStyle },
      className: "rcb-chat-input",
      children: [
        s && ((G = t.sensitiveInput) != null && G.maskInTextArea) ? /* @__PURE__ */ l(
          "input",
          {
            ref: u,
            type: "password",
        ...
        /* @__PURE__ */ z(tA, { children: [
          A == null ? void 0 : A.map(
            (K, V) => /* @__PURE__ */ l(YA, { children: K }, V)
          ),
          ((j = t.chatInput) == null ? void 0 : j.showCharacterCount) && ((U = t.chatInput) == null ? void 0 : U.characterLimit) != null && ((Y = t.chatInput) == null ? void 0 : Y.characterLimit) > 0 && /* @__PURE__ */ z(
            "div",
            {
              className: "rcb-chat-input-char-counter",
              style: a >= ((N = t.chatInput) == null ? void 0 : N.characterLimit) ? B : Q,
              children: [
                a,
                "/",
                (J = t.chatInput) == null ? void 0 : J.characterLimit
              ]
            }
          )
        ] })
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ l("div", { className: "rcb-chat-footer", children: A == null ? void 0 : A.map(
          (n, s) => /* @__PURE__ */ l(YA, { children: n }, s)
        ) }),
        /* @__PURE__ */ l("span", { children: (o = e.footer) == null ? void 0 : o.text })
      ]
    }
  );
}, _t = () => {
  var c, i, u, f, h, d, w;
  const { settings: A } = M(), { styles: e } = R(), { unreadCount: t } = eA(), { isChatWindowOpen: o, toggleChatWindow: n } = wA(), s = {
    ...
    var v;
    const D = (v = A.chatButton) == null ? void 0 : v.icon;
    ...
    ) : D && /* @__PURE__ */ l("span", { className: "rcb-toggle-icon", children: /* @__PURE__ */ l(D, { style: a }) });
  };
  return /* @__PURE__ */ l(tA, { children: !((f = A.general) != null && f.embedded) && /* @__PURE__ */ z(
    "div",
    {
      ...
      children: [
        r(),
        !((d = A.notification) != null && d.disabled) && ((w = A.notification) == null ? void 0 : w.showCount) && /* @__PURE__ */ l("span", { style: { ...e.notificationBadgeStyle }, className: "rcb-badge", children: t })
      ]
    }
  ) });
}, $t = () => {
  var d, w, D, v;
  const A = NA(), { settings: e } = M(), { styles: t } = R(), { isChatWindowOpen: o, openChat: n } = wA(), [s, a] = I(!1), [r, c] = I(!1), [i, u] = I(0);
  W(() => {
    var g, C, Q;
    const P = (g = e.tooltip) == null ? void 0 : g.mode;
    if (P === "ALWAYS")
      if (A) {
        let B;
        o ? B = (((C = t.chatWindowStyle) == null ? void 0 : C.width) ?? 375) - (((Q = t.chatButtonStyle) == null ? void 0 : Q.width) ?? 75) : B = 0, u(B), a(!0);
      } else
        a(!o);
    else P === "NEVER" ? a(!1) : P === "START" ? r ? a(!1) : (c(!0), a(!0)) : P === "CLOSE" && a(!o);
  }, [o]);
  const f = {
    transform: `translateX(-${i}px)`,
    right: (((d = t.chatButtonStyle) == null ? void 0 : d.width) ?? 75) + 40,
    bottom: 30,
    backgroundColor: (w = e.general) == null ? void 0 : w.secondaryColor,
    color: "#fff",
    ...t.tooltipStyle
  }, h = {
    borderColor: `transparent transparent transparent ${f.backgroundColor}`
  };
  return /* @__PURE__ */ l(tA, { children: !((D = e.general) != null && D.embedded) && /* @__PURE__ */ z(
    "div",
    {
      ...
      onClick: () => n(!0),
      children: [
        /* @__PURE__ */ l("span", { children: (v = e.tooltip) == null ? void 0 : v.text }),
  ...
  }, [A, a, t]), typeof e == "string" ? /* @__PURE__ */ l(
    "div",
    {
      onMouseEnter: () => {
        c(!0);
      ...
      onMouseDown: async (w) => {
        var D;
        (D = o.toast) != null && D.dismissOnClick && (w.preventDefault(), await a(A));
      },
      className: "rcb-toast-prompt",
      children: e
    }
  ) : /* @__PURE__ */ l(tA, { children: e });
}, eo = () => {
  var o, n, s, a;
  const { styles: A } = R(), { toasts: e } = Ie(), t = {
  ...
  return /* @__PURE__ */ l("div", { className: "rcb-toast-prompt-container", style: t, children: e.map((r) => /* @__PURE__ */ l(
    Ao,
    {
      id: r.id,
      content: r.content,
  ...
  var a, r, c;
  const { settings: o } = M(), { styles: n } = R(), s = {
  ...
  return /* @__PURE__ */ l(tA, { children: t ? /* @__PURE__ */ z(tA, { children: [
    e === "image" && t && /* @__PURE__ */ l(
      "div",
      {
        style: s,
        className: "rcb-media-display-image-container rcb-media-entry",
        "data-testid": "media-display-image-container",
        children: /* @__PURE__ */ l("img", { src: t, alt: "Image Display", className: "rcb-media-display-image" })
      }
    ),
    e === "video" && t && /* @__PURE__ */ l(
      "div",
      {
        style: s,
        className: "rcb-media-display-video-container rcb-media-entry",
        "data-testid": "media-display-video-container",
        children: /* @__PURE__ */ z("video", { controls: !0, className: "rcb-media-display-video", children: [
          /* @__PURE__ */ l("source", { src: t, type: A.type }),
          "Your browser does not support the video tag."
        ] })
      }
    ),
    e === "audio" && t && /* @__PURE__ */ z(
      "audio",
      {
  ...
  var k, y, S, m, p, x;
  const { settings: A } = M(), { styles: e } = R(), { injectMessage: t, streamMessage: o, removeMessage: n, endStreamMessage: s } = yA(), { getCurrPath: a, getPrevPath: r, goToPath: c, blockAllowsAttachment: i } = TA(), { flowRef: u, inputRef: f } = AA(), h = u.current, { showToast: d, dismissToast: w } = mA(), { callRcbEvent: D } = dA(), { openChat: v } = wA(), { setTextAreaValue: P } = bA(), { handleSubmitText: g } = pA(), C = {
    cursor: `url("${(k = A.general) == null ? void 0 : k.actionDisabledIcon}"), auto`,
    ...e.fileAttachmentButtonStyle,
    // by default inherit the base style
    ...e.fileAttachmentButtonDisabledStyle
  }, Q = {
    backgroundImage: `url(${(y = A.fileAttachment) == null ? void 0 : y.icon})`,
    fill: "#a6a6a6",
    ...
    if (!L || (j = A.event) != null && j.rcbUserUploadFile && (await D(H.USER_UPLOAD_FILE, { files: L })).defaultPrevented)
      return;
    const F = a();
    if (!F)
      return;
    ...
    if (G != null) {
      ...
      for (let K = 0; K < L.length; K++) {
        if (J.push(L[K].name), !((U = A.fileAttachment) != null && U.showMediaDisplay))
          continue;
        const V = await Te(L[K]);
        !V.fileType || !V.fileUrl || await t(/* @__PURE__ */ l(
          Se,
          {
            file: L[K],
            fileType: V.fileType,
      ...
      await g("📄 " + J.join(", "), (Y = A.fileAttachment) == null ? void 0 : Y.sendFileName), await G({
        userInput: (N = f.current) == null ? void 0 : N.value,
        prevPath: r(),
        currPath: a(),
        goToPath: c,
        setTextAreaValue: P,
    ...
    var L, F;
    const O = i ? (L = A.fileAttachment) == null ? void 0 : L.icon : (F = A.fileAttachment) == null ? void 0 : F.iconDisabled;
    return !O || typeof O == "string" ? /* @__PURE__ */ l(
      "span",
      {
        className: i ? "rcb-attach-icon-enabled" : "rcb-attach-icon-disabled",
        style: i ? Q : B
      }
    ) : O && /* @__PURE__ */ l("span", { className: i ? "rcb-attach-icon-enabled" : "rcb-attach-icon-disabled", children: /* @__PURE__ */ l(
      O,
      {
        style: i ? Q : B
      }
  ...
  return /* @__PURE__ */ z(
    "label",
    {
      "aria-label": ((m = A.ariaLabel) == null ? void 0 : m.fileAttachmentButton) ?? "upload file",
      role: "button",
      className: i ? "rcb-attach-button-enabled" : "rcb-attach-button-disabled",
      style: i ? { ...e.fileAttachmentButtonStyle } : C,
      children: [
        /* @__PURE__ */ l(
          "input",
          {
            ...
            accept: (x = A.fileAttachment) == null ? void 0 : x.accept,
            disabled: !i
          }
        ),
        b()
  ...
  var D, v, P, g, C, Q;
  const { settings: A } = M(), { styles: e } = R(), { inputRef: t } = AA(), { textAreaDisabled: o, setTextAreaValue: n } = bA(), s = $(null), a = $(null), [r, c] = I(!1), i = {
    cursor: `url("${(D = A.general) == null ? void 0 : D.actionDisabledIcon}"), auto`,
    ...e.emojiButtonStyle,
    // by default inherit the base style
    ...e.emojiButtonDisabledStyle
  }, u = {
    backgroundImage: `url(${(v = A.emoji) == null ? void 0 : v.icon})`,
    fill: "#a6a6a6",
    ...e.emojiIconStyle
  }, f = {
  ...
  W(() => {
    const B = (k) => {
      const y = k.composedPath();
      s.current && !y.includes(s.current) && a.current && !y.includes(a.current) && c(!1);
    }, E = () => {
      if (s.current && a.current) {
        const k = a.current.getBoundingClientRect(), y = s.current.offsetHeight, S = k.top - y - 8;
        s.current.style.left = `${k.left}px`, s.current.style.top = `${S}px`;
      }
    }, b = () => {
      E();
    };
    return document.addEventListener("mousedown", B), window.addEventListener("resize", b), () => {
      document.removeEventListener("mousedown", B), window.removeEventListener("resize", b);
    };
  }, []);
  const h = (B, E) => {
    B.preventDefault(), t.current && (n(t.current.value + E), setTimeout(() => {
      const b = t.current;
      if (b) {
        b.focus();
    ...
    B.preventDefault(), c(o ? !1 : !r);
  }, w = () => {
    var E, b;
    const B = o ? (E = A.emoji) == null ? void 0 : E.iconDisabled : (b = A.emoji) == null ? void 0 : b.icon;
    ...
    ) : B && /* @__PURE__ */ l("span", { className: `${o ? "rcb-emoji-icon-disabled" : "rcb-emoji-icon-enabled"}`, children: /* @__PURE__ */ l(B, { style: o ? f : u }) });
  };
  return /* @__PURE__ */ z(tA, { children: [
    /* @__PURE__ */ l(
      "div",
      {
        "aria-label": ((g = A.ariaLabel) == null ? void 0 : g.emojiButton) ?? "emoji picker",
        role: "button",
        ref: a,
        className: `${o ? "rcb-emoji-button-disabled" : "rcb-emoji-button-enabled"}`,
        style: o ? i : { ...e.emojiButtonStyle },
        onMouseDown: d,
        children: w()
      }
    ),
    r && /* @__PURE__ */ l("div", { className: "rcb-emoji-button-popup", ref: s, children: (Q = (C = A.emoji) == null ? void 0 : C.list) == null ? void 0 : Q.map((B, E) => /* @__PURE__ */ l(
      "span",
      {
        className: "rcb-emoji",
        onMouseDown: (b) => h(b, B),
  ...
  var r, c, i;
  const { settings: A } = M(), { styles: e } = R(), { audioToggledOn: t, toggleAudio: o } = JA(), n = {
    ...
    var f, h;
    const u = t ? (f = A.audio) == null ? void 0 : f.icon : (h = A.audio) == null ? void 0 : h.iconDisabled;
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      ...
      style: t ? { ...e.audioButtonStyle } : { ...e.audioButtonStyle, ...e.audioButtonDisabledStyle },
      children: a()
    }
  );
}, so = () => {
  var s, a;
  const { settings: A } = M(), { styles: e } = R(), { openChat: t } = wA(), o = {
  ...
  const { notificationsToggledOn: A, toggleNotifications: e, playNotificationSound: t } = qA();
  return {
  ...
  var r, c, i;
  const { settings: A } = M(), { styles: e } = R(), { notificationsToggledOn: t, toggleNotifications: o } = ro(), n = {
    ...
    var f, h;
    const u = t ? (f = A.notification) == null ? void 0 : f.icon : (h = A.notification) == null ? void 0 : h.iconDisabled;
    return !u || typeof u == "string" ? /* @__PURE__ */ l(
      "span",
      {
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      ...
      style: t ? { ...e.notificationButtonStyle } : { ...e.notificationButtonStyle, ...e.notificationButtonDisabledStyle },
      children: a()
    }
  );
}, co = () => {
  var g, C, Q;
  const { settings: A } = M(), { styles: e } = R(), { injectMessage: t } = yA(), { inputRef: o } = AA(), { voiceToggledOn: n, toggleVoice: s } = LA(), { setInputLength: a, setTextAreaValue: r, textAreaDisabled: c } = bA(), { handleSubmitText: i } = pA(), u = $([]), [f, h] = I(!1);
  W(() => {
    var B;
    (B = A.voice) != null && B.sendAsAudio ? (v(), u.current = []) : i();
  }, [f]), W(() => {
    n ? Xt(
      A,
      s,
  ...
  const d = {
    backgroundImage: `url(${(g = A.voice) == null ? void 0 : g.icon})`,
    fill: "#9aa0a6",
    ...e.voiceIconStyle
  }, w = {
    backgroundImage: `url(${(C = A.voice) == null ? void 0 : C.iconDisabled})`,
    fill: "#9aa0a6",
    ...e.voiceIconStyle,
    // by default inherit the base style
    ...
    const B = new Blob(u.current, { type: "audio/wav" }), E = new File([B], "voice-input.wav", { type: "audio/wav" }), b = await Te(E);
    !b.fileType || !b.fileUrl || await t(/* @__PURE__ */ l(
      Se,
      {
        file: E,
        fileType: b.fileType,
    ...
    var E, b;
    const B = n ? (E = A.voice) == null ? void 0 : E.icon : (b = A.voice) == null ? void 0 : b.iconDisabled;
    return !B || typeof B == "string" ? /* @__PURE__ */ l(
      "span",
      {
    ...
    ) : B && /* @__PURE__ */ l("span", { className: `rcb-voice-icon ${n && !c ? "on" : ""}`, children: /* @__PURE__ */ l(B, { style: n && !c ? d : w }) });
  };
  return /* @__PURE__ */ l(
    "div",
    {
      "aria-label": ((Q = A.ariaLabel) == null ? void 0 : Q.voiceButton) ?? "toggle voice",
      role: "button",
      onMouseDown: async (B) => {
        B.preventDefault(), !c && await s();
      },
  ...
  var D, v, P, g, C, Q, B, E;
  const { settings: A } = M(), { styles: e } = R(), { textAreaDisabled: t } = eA(), [o, n] = I(!1), { handleSubmitText: s } = pA(), a = {
    backgroundColor: (D = A.general) == null ? void 0 : D.primaryColor,
    ...e.sendButtonStyle
  }, r = {
    cursor: `url("${(v = A.general) == null ? void 0 : v.actionDisabledIcon}"), auto`,
    backgroundColor: (P = A.general) == null ? void 0 : P.primaryColor,
    ...e.sendButtonStyle,
    // by default inherit the base style
    ...e.sendButtonDisabledStyle
  }, c = {
    backgroundColor: (g = A.general) == null ? void 0 : g.secondaryColor,
    ...e.sendButtonStyle,
    // by default inherit the base style
    ...e.sendButtonHoveredStyle
  }, i = {
    backgroundImage: `url(${(C = A.chatInput) == null ? void 0 : C.sendButtonIcon})`,
    fill: "#fff",
    ...e.sendIconStyle
  }, u = {
    ...
    backgroundImage: `url(${(B = A.chatInput) == null ? void 0 : B.sendButtonIcon})`,
    fill: "#fff",
    ...e.sendIconStyle,
    // by default inherit the base style
    ...
    var k;
    const b = (k = A.chatInput) == null ? void 0 : k.sendButtonIcon;
    return !b || typeof b == "string" ? /* @__PURE__ */ l(
      "span",
      {
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      "aria-label": ((E = A.ariaLabel) == null ? void 0 : E.sendButton) ?? "send message",
      role: "button",
      onMouseEnter: h,
      onMouseLeave: d,
      onMouseDown: async (b) => {
        b == null || b.preventDefault(), !t && await s();
      },
      style: t ? r : o ? c : a,
...
}, lo = (A) => Object.values(q).includes(A), uo = (A, e) => {
  var c, i, u, f, h, d, w, D, v;
  const t = {
    [q.AUDIO_BUTTON]: (c = A.audio) == null ? void 0 : c.disabled,
    [q.CLOSE_CHAT_BUTTON]: (i = A.general) == null ? void 0 : i.embedded,
    [q.EMOJI_PICKER_BUTTON]: (u = A.emoji) == null ? void 0 : u.disabled,
    [q.FILE_ATTACHMENT_BUTTON]: (f = A.fileAttachment) == null ? void 0 : f.disabled,
    [q.NOTIFICATION_BUTTON]: (h = A.notification) == null ? void 0 : h.disabled,
    [q.SEND_MESSAGE_BUTTON]: !1,
    [q.VOICE_MESSAGE_BUTTON]: (d = A.voice) == null ? void 0 : d.disabled
  }, o = {}, n = (P) => P ? P.map((g) => {
    if (typeof g == "string") {
      if (lo(g) && !t[g]) {
        if (o[g])
    ...
    return g;
  }).filter((g) => g !== null) : [], s = n((w = A.header) == null ? void 0 : w.buttons), a = n((D = A.chatInput) == null ? void 0 : D.buttons), r = n((v = A.footer) == null ? void 0 : v.buttons);
  return { header: s, chatInput: a, footer: r };
}, fo = () => /* @__PURE__ */ l(no, {}), wo = () => /* @__PURE__ */ l(ao, {}), go = () => /* @__PURE__ */ l(so, {}), Bo = () => /* @__PURE__ */ l(co, {}), vo = () => /* @__PURE__ */ l(io, {}), Po = () => /* @__PURE__ */ l(to, {}), ho = () => /* @__PURE__ */ l(oo, {}), Do = () => {
  const { settings: A } = M(), e = gA(() => ({
    [q.CLOSE_CHAT_BUTTON]: () => go(),
    [q.AUDIO_BUTTON]: () => fo(),
    [q.NOTIFICATION_BUTTON]: () => wo(),
    [q.EMOJI_PICKER_BUTTON]: () => ho(),
    [q.FILE_ATTACHMENT_BUTTON]: () => Po(),
    [q.SEND_MESSAGE_BUTTON]: () => vo(),
    [q.VOICE_MESSAGE_BUTTON]: () => Bo()
  }), []), { header: t, chatInput: o, footer: n } = gA(() => uo(A, e), [A, e]), s = gA(() => t, [t]), a = gA(() => o, [o]), r = gA(() => n, [n]);
  return { headerButtons: s, chatInputButtons: a, footerButtons: r };
}, _A = () => {
  const { settings: A } = M(), { styles: e } = R(), { setMessages: t } = WA(), {
    isLoadingChatHistory: o,
    setIsLoadingChatHistory: n,
    hasChatHistoryLoaded: s,
    setHasChatHistoryLoaded: a
  } = eA(), { chatBodyRef: r } = AA(), { callRcbEvent: c } = dA(), { chatScrollHeight: i } = wA(), u = T(async () => {
    var h;
    const f = KA();
    f && ((h = A.event) != null && h.rcbLoadChatHistory && (await c(H.LOAD_CHAT_HISTORY, {})).defaultPrevented || (n(!0), Nt(
      A,
      e,
      f,
      t,
  ...
  return { isLoadingChatHistory: o, setIsLoadingChatHistory: n, hasChatHistoryLoaded: s, showChatHistory: u };
}, Eo = () => {
  var c, i, u;
  const { settings: A } = M(), { styles: e } = R(), { showChatHistory: t } = _A(), [o, n] = I(!1), s = {
  ...
  return /* @__PURE__ */ l("div", { className: "rcb-view-history-container", children: /* @__PURE__ */ l(
    "div",
    {
      ...
      style: o ? s : { ...e.chatHistoryButtonStyle },
      onMouseDown: (f) => {
        f.preventDefault(), t();
      },
  ...
  var a;
  const { settings: A } = M(), { hasInteractedPage: e, setHasInteractedPage: t, hasFlowStarted: o, setHasFlowStarted: n } = eA(), s = T(() => {
    var c;
    if (t(!0), !o && ((c = A.general) == null ? void 0 : c.flowStartTrigger) === "ON_PAGE_INTERACT" && n(!0), !window.SpeechSynthesisUtterance) {
      console.info("Speech Synthesis API is not supported in this environment.");
      return;
    }
  ...
  var vA, iA, Ae, ee, te;
  const A = NA(), { settings: e } = M(), {
    endStreamMessage: t,
    injectMessage: o,
    removeMessage: n,
    streamMessage: s,
    replaceMessages: a
  } = yA(), { getCurrPath: r, getPrevPath: c, goToPath: i, paths: u } = TA(), { showToast: f, dismissToast: h } = mA(), {
    isBotTyping: d,
    isChatWindowOpen: w,
    isScrolling: D,
    hasFlowStarted: v,
    ...
    setTimeoutId: k
  } = eA(), { chatBodyRef: y, flowRef: S, streamMessageMap: m, paramsInputRef: p, keepVoiceOnRef: x } = AA(), O = S.current, { viewportHeight: L, setViewportHeight: F, setViewportWidth: _, openChat: G } = wA(), { setUpNotifications: j } = qA(), { handleFirstInteraction: U } = Me(), { showChatHistory: Y } = _A(), { updateTextAreaFocus: N, setTextAreaValue: J } = bA(), { syncVoice: K } = LA(), V = $(0);
  W(() => (window.addEventListener("click", U), window.addEventListener("keydown", U), window.addEventListener("touchstart", U), () => {
    window.removeEventListener("click", U), window.removeEventListener("keydown", U), window.removeEventListener("touchstart", U);
  }), []), W(() => {
    var Z, oA, sA;
    g((Z = e.chatInput) == null ? void 0 : Z.disabled), P((oA = e.chatWindow) == null ? void 0 : oA.defaultOpen), C((sA = e.audio) == null ? void 0 : sA.defaultToggledOn), setTimeout(() => {
      var rA;
      Q((rA = e.voice) == null ? void 0 : rA.defaultToggledOn);
    }, 1);
  }, []), W(() => {
    var Z;
    (Z = e.notification) != null && Z.disabled || j();
  }, [(vA = e.notification) == null ? void 0 : vA.disabled]), W(() => {
    !D && (y != null && y.current) && (y.current.scrollTop = y.current.scrollHeight);
  }, [d]), W(() => {
    var Z, oA;
    if ((Z = e.chatHistory) != null && Z.disabled)
      Ot();
    else if (GA(e), KA().length > 0) {
      const rA = QA(/* @__PURE__ */ l(Eo, {}), "SYSTEM");
      a([rA]), (oA = e.chatHistory) != null && oA.autoLoad && Y();
    }
  }, [(iA = e.chatHistory) == null ? void 0 : iA.storageKey, (Ae = e.chatHistory) == null ? void 0 : Ae.maxEntries, (ee = e.chatHistory) == null ? void 0 : ee.disabled]), W(() => {
    var Z;
    A || (Z = e.general) != null && Z.embedded || !navigator.virtualKeyboard || (navigator.virtualKeyboard.overlaysContent = !0, navigator.virtualKeyboard.addEventListener("geometrychange", (oA) => {
      if (!oA.target)
        return;
      const { x: sA, y: rA, width: CA, height: lA } = oA.target.boundingRect;
      sA == 0 && rA == 0 && CA == 0 && lA == 0 ? (setTimeout(() => {
        var nA;
        F((nA = window.visualViewport) == null ? void 0 : nA.height);
      }, 101), setTimeout(() => {
        var nA, PA;
        L != ((nA = window.visualViewport) == null ? void 0 : nA.height) && F((PA = window.visualViewport) == null ? void 0 : PA.height);
      }, 1001)) : setTimeout(() => {
        var nA;
        F(((nA = window.visualViewport) == null ? void 0 : nA.height) - lA);
      }, 101);
    }));
  }, [A]), W(() => {
    var CA, lA, nA, PA;
    if (A)
      return;
    w && (F((CA = window.visualViewport) == null ? void 0 : CA.height), _((lA = window.visualViewport) == null ? void 0 : lA.width));
    const Z = () => window.scrollTo({ top: 0, left: 0, behavior: "auto" }), oA = () => V.current = window.scrollY, sA = () => {
      var IA, oe;
      F((IA = window.visualViewport) == null ? void 0 : IA.height), _((oe = window.visualViewport) == null ? void 0 : oe.width);
    }, rA = () => {
      var IA;
      window.removeEventListener("scroll", Z), window.removeEventListener("scroll", oA), (IA = window.visualViewport) == null || IA.removeEventListener("resize", sA);
    };
    return w ? (rA(), document.body.style.position = "fixed", window.addEventListener("scroll", Z), (nA = window.visualViewport) == null || nA.addEventListener("resize", sA)) : (document.body.style.position = "static", rA(), window.scrollTo({ top: V.current, left: 0, behavior: "auto" }), window.addEventListener("scroll", oA), (PA = window.visualViewport) == null || PA.removeEventListener("resize", sA)), rA;
  }, [w, A]), W(() => {
    const Z = r();
    if (!Z)
      return;
    ...
    (async (CA, lA, nA) => {
      ...
      await Tt(
        ...
        i,
        k
      ), B(!1), "chatDisabled" in lA || g((PA = e.chatInput) == null ? void 0 : PA.disabled), "isSensitive" in lA || E(!1), b(typeof lA.file == "function"), N(CA), K(x.current && !lA.chatDisabled), m.current.clear();
    })(Z, oA, sA);
  }, [u]), W(() => {
    var Z;
    (v || ((Z = e.general) == null ? void 0 : Z.flowStartTrigger) === "ON_LOAD") && i("start");
  }, [v, (te = e.general) == null ? void 0 : te.flowStartTrigger]);
}, $A = {
...
}, Qo = $A.DEFAULT_URL, bo = $A.DEFAULT_EXPIRATION, ke = $A.CACHE_KEY_PREFIX, yo = (A, e, t) => {
  const o = localStorage.getItem(`${ke}_${A}_${e}`);
  if (!o)
    return null;
  try {
    const n = JSON.parse(o), s = (/* @__PURE__ */ new Date()).getTime(), a = Math.floor(s / 1e3);
    return n.cacheDate + t >= a ? n : null;
  } catch (n) {
  ...
  localStorage.setItem(`${ke}_${A}_${e}`, JSON.stringify(r));
}, po = async (A, e) => {
  const t = `${e}/${A}/meta.json`;
  try {
    const o = await fetch(t);
    return o.ok ? (await o.json()).version : (console.error(`Failed to fetch meta.json from ${t}`), null);
  } catch (o) {
    return console.error(`Failed to fetch meta.json from ${t}`, o), null;
  }
}, ie = async (A, e) => {
  const { id: t, version: o, baseUrl: n = Qo, cacheDuration: s = bo } = e, a = o || await po(t, n);
  if (!a)
    return console.error(`Unable to find version for theme: ${t}`), { settings: {}, inlineStyles: {}, cssStylesText: "" };
  const r = yo(t, a, s);
  if (r) {
    const g = le(A, r.cssStylesText);
    return { settings: r.settings, inlineStyles: r.inlineStyles, cssStylesText: g };
  }
  const c = `${n}/${t}/${a}/styles.css`, i = `${n}/${t}/${a}/settings.json`, u = `${n}/${t}/${a}/styles.json`;
  let f = "";
  const h = await fetch(c);
  h.ok ? f = await h.text() : console.info(`Could not fetch styles.css from ${c}`);
  const d = await fetch(i);
  let w = {};
  d.ok ? w = await d.json() : console.info(`Could not fetch settings.json from ${i}`);
  const D = await fetch(u);
  let v = {};
  D.ok ? v = await D.json() : console.info(`Could not fetch styles.json from ${u}`), mo(t, a, w, v, f);
  const P = le(A, f);
  return { settings: w, inlineStyles: v, cssStylesText: P };
}, le = (A, e) => e.split(new RegExp("(?<=})")).map((o) => {
  const n = o.trim();
  return n.startsWith("@import") || n.startsWith("@keyframes") || n.startsWith("@media") ? n : n ? `#${A} ${n}` : "";
}).join(`
`), Io = () => FA(fe), So = () => FA(we), To = async (A, e, t, o) => {
  var r, c;
  let n = Io(), s = So(), a = "";
  if (o != null)
    if (Array.isArray(o))
      for (const i of o) {
        const u = await ie(A, i);
        n = fA(u.settings, n), s = fA(u.inlineStyles, s), a += u.cssStylesText;
      }
    else {
      const i = await ie(A, o);
      n = fA(i.settings, n), s = fA(i.inlineStyles, s), a += i.cssStylesText;
    }
  return e != null && (n = fA(e, n)), t != null && (s = fA(t, s)), ((r = n.chatInput) == null ? void 0 : r.botDelay) != null && ((c = n.chatInput) == null ? void 0 : c.botDelay) < 500 && (n.chatInput.botDelay = 500), { settings: n, inlineStyles: s, cssStylesText: a };
}, fA = (A, e) => {
  ...
  for (; t.length; ) {
    ...
    for (const a of Object.keys(n)) {
      ...
      if (ue(n[r]))
        ...
        (typeof s[r] != "object" || s[r] === null) && (s[r] = {}), t.push({ source: n[r], target: s[r] });
      else
        try {
          s[r] = n[r];
        } catch {
      ...
      if (Object.prototype.hasOwnProperty.call(s, r)) {
        ...
        if (c && typeof c == "object")
          if (o.has(c))
            ...
            o.set(c, i), a[r] = i, t.push({ source: c, target: i });
          }
        else
          a[r] = c;
      }
  ...
  const { settings: A, setSettings: e } = M(), t = T((n) => {
    !n || Object.keys(n).length === 0 || e(FA(fA(n, A)));
  }, [A]), o = T((n) => {
    e(n);
  }, []);
  return {
  ...
  const { styles: A, setStyles: e } = R(), t = T((n) => {
    !n || Object.keys(n).length === 0 || e(FA(fA(n, A)));
  }, [A]), o = T((n) => {
    e(n);
  }, []);
  ...
  const { updateSettings: e } = He(), { updateStyles: t } = xe(), o = A == null ? void 0 : A.map((n) => n());
  W(() => {
    let n = {}, s = {};
    o == null || o.forEach((a) => {
  ...
  var P, g, C, Q;
  const e = NA(), { settings: t } = M(), { styles: o } = R(), { hasFlowStarted: n, setHasFlowStarted: s } = eA(), { inputRef: a } = AA(), {
    setChatScrollHeight: r,
    viewportHeight: c,
    viewportWidth: i,
    isChatWindowOpen: u
  } = wA(), { headerButtons: f, chatInputButtons: h, footerButtons: d } = Do();
  Co(), Mo(A);
  const w = gA(() => {
    var E;
    const B = "rcb-chatbot-global ";
    return (E = t.general) != null && E.embedded ? B + "rcb-window-embedded" : u ? B + "rcb-window-open" : B + "rcb-window-close";
  }, [t, u]), D = () => {
    var B, E;
    return !e && !((B = t.general) != null && B.embedded) ? {
      ...o.chatWindowStyle,
      borderRadius: "0px",
      left: "0px",
      right: "auto",
      ...
      height: `${c}px`,
      zIndex: 1e4
    } : (E = t.general) != null && E.embedded ? { ...o.chatWindowStyle } : {
      ...o.chatWindowStyle,
      zIndex: 1e4
    };
  };
  return /* @__PURE__ */ l(tA, { children: (() => {
    var B, E;
    return e && ((B = t.device) == null ? void 0 : B.desktopEnabled) || !e && ((E = t.device) == null ? void 0 : E.mobileEnabled);
  })() && /* @__PURE__ */ z(
    "div",
    {
      onMouseDown: (B) => {
        var E, b;
        !n && ((E = t.general) == null ? void 0 : E.flowStartTrigger) === "ON_CHATBOT_INTERACT" && s(!0), e ? (b = a.current) == null || b.blur() : B == null || B.preventDefault();
      },
      className: w,
      children: [
        /* @__PURE__ */ l($t, {}),
        /* @__PURE__ */ l(_t, {}),
        u && !e && !((P = t.general) != null && P.embedded) && /* @__PURE__ */ z(tA, { children: [
        ...
        /* @__PURE__ */ z("div", { style: D(), className: "rcb-chat-window", children: [
          ((g = t.general) == null ? void 0 : g.showHeader) && /* @__PURE__ */ l(ct, { buttons: f }),
          /* @__PURE__ */ l(ht, { setChatScrollHeight: r }),
          /* @__PURE__ */ l(eo, {}),
          ((C = t.general) == null ? void 0 : C.showInputRow) && /* @__PURE__ */ l(Vt, { buttons: h }),
          ((Q = t.general) == null ? void 0 : Q.showFooter) && /* @__PURE__ */ l(Zt, { buttons: d })
        ] })
      ]
    }
  ) });
}, Oe = DA(void 0), Le = () => EA(Oe), Ho = ({
  children: A
}) => {
  var u;
  const e = $(""), t = $({}), [o, n] = I({}), [s, a] = I({}), [r, c] = I(!1);
  W(() => {
    c(!0);
  }, []);
  const i = async (f, h, d, w, D, v) => {
    e.current = f, t.current = h;
    const P = await To(f, d, w, D);
    v.current && (v.current.textContent = P.cssStylesText), n(P.settings), a(P.inlineStyles);
  };
  return r ? /* @__PURE__ */ l("div", { style: { fontFamily: (u = o.general) == null ? void 0 : u.fontFamily }, children: /* @__PURE__ */ l(Oe.Provider, { value: { loadConfig: i }, children: /* @__PURE__ */ l(rt, { settings: o, setSettings: n, children: /* @__PURE__ */ l(at, { styles: s, setStyles: a, children: /* @__PURE__ */ l(Jt, { children: /* @__PURE__ */ l(it, { botIdRef: e, flowRef: t, children: /* @__PURE__ */ l(dt, { children: /* @__PURE__ */ l(lt, { settings: o, children: /* @__PURE__ */ l(gt, { children: A }) }) }) }) }) }) }) }) }) : null;
}, xo = ({
  id: A,
  flow: e,
  settings: t,
  ...
  const c = gA(() => A, []), i = Le(), { flowRef: u } = AA();
  u && u.current !== e && (u.current = e);
  const f = async () => {
    var h, d;
    (h = t.event) != null && h.rcbPreLoadChatBot && (await HA(
      H.PRE_LOAD_CHATBOT,
    ...
    )).defaultPrevented || (i != null && i.loadConfig && (await i.loadConfig(c, e, t, o, n, r), a(!0)), (d = t.event) != null && d.rcbPostLoadChatBot && HA(
      H.POST_LOAD_CHATBOT,
      { botId: c, currPath: null, prevPath: null },
      {
        flow: e,
...
}, zA = ["Quickstart", "API Docs", "Examples", "Github", "Discord"], Oo = {
  start: {
  ...
  const a = gA(() => A || "rcb-" + xA(), []), r = !e || Object.keys(e).length === 0 ? Oo : e, c = t || {}, i = o || {}, u = s || [], [f, h] = I(!1), d = Le(), w = $(null), [D, v] = I(n || []);
  W(() => {
    n && v(n);
  }, [n]);
  const P = () => /* @__PURE__ */ z(tA, { children: [
    /* @__PURE__ */ l(
      xo,
      {
        styleRootRef: w,
    ...
    f && /* @__PURE__ */ l(ko, { plugins: s })
  ] });
  return d == null ? /* @__PURE__ */ z(Ho, { children: [
    /* @__PURE__ */ l("style", { ref: w }),
    /* @__PURE__ */ l("div", { id: a, children: P() })
  ] }) : /* @__PURE__ */ z(tA, { children: [
    /* @__PURE__ */ l("style", { ref: w }),
    /* @__PURE__ */ l("div", { id: a, children: P() })
  ] });
}, Go = () => {
  const { audioToggledOn: A, toggleAudio: e } = JA();
  return {
    audioToggledOn: A,
    toggleAudio: e
  };
  ...
  const { isChatWindowOpen: A, toggleChatWindow: e } = wA();
  return {
    isChatWindowOpen: A,
    toggleChatWindow: e
  };
  ...
  const { replaceMessages: A } = yA(), { replacePaths: e } = TA(), { replaceToasts: t } = mA(), { hasFlowStarted: o } = eA(), { flowRef: n } = AA(), { settings: s } = M(), a = T(() => {
    GA(s), A([]), t([]), e(["start"]);
  }, [A, t, e, GA]), r = T(() => (n == null ? void 0 : n.current) ?? {}, [n]);
  return {
    hasFlowStarted: o,
    restartFlow: a,
    getFlow: r
  ...
  const { hasFlowStarted: A, restartFlow: e, getFlow: t } = No();
  return {
    hasFlowStarted: A,
    restartFlow: e,
    getFlow: t
  ...
  const { settings: A, replaceSettings: e, updateSettings: t } = He();
  return {
    settings: A,
    replaceSettings: e,
    updateSettings: t
  ...
  const { styles: A, replaceStyles: e, updateStyles: t } = xe();
  return {
    styles: A,
    replaceStyles: e,
    updateStyles: t
  ...
  const { showToast: A, dismissToast: e, toasts: t, replaceToasts: o } = mA();
  return {
    showToast: A,
    dismissToast: e,
    toasts: t,
  ...
  const { voiceToggledOn: A, toggleVoice: e } = LA();
  return {
    voiceToggledOn: A,
    toggleVoice: e
  };
}, An = () => {
  const { showChatHistory: A, hasChatHistoryLoaded: e } = _A();
  return {
    showChatHistory: A,
    getHistoryMessages: KA,
    setHistoryMessages: xt,
    hasChatHistoryLoaded: e
  };
};
export {
  q as Button,
  Ho as ChatBotProvider,
  zo as default,
  Io as getDefaultSettings,
  So as getDefaultStyles,
  Go as useAudio,
  Yo as useBotId,
  An as useChatHistory,
  Xo as useChatWindow,
  Wo as useFirstInteraction,
  Ko as useFlow,
  qo as useMessages,
